...
# Class2021 2022 1 Java Course

Class2021 2022 1 java course: no README or manifest to go on; based on its name, built with Java, this looks like a learning exercise — open the repository to confirm.
...
```sh
Class2021_2022_1_Java_course --help
```
